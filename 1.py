...
def intro_loop():
    ...
    while intro:
        ...
        TextSurf,TextRect=text_objects("Racing With Sumo",largetext)
...
def introduction():
    ...
    while introduction:
        ...
        textSurf,textRect=text_objects("This is a racing game in which you need dodge the coming cars",smalltext)
